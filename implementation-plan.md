...
- [x] Scope 0 — Repo bootstrap (0.1–0.2)
- [x] Scope 1 — CLI shell (1.1–1.3)
- [x] Scope 2 — Config types + defaults (2.1–2.3)
- [x] Scope 3 — Config loader (3.1–3.4)
- [x] Scope 4 — Validation (4.1–4.3)
- [x] Scope 5 — Message formatting (5.1)
- [x] Scope 6 — Git helpers (6.1–6.2)
- [x] Scope 7 — Inline parser (7.1–7.5)
- [x] Scope 8 — Prompt primitives (8.1–8.6)
- [x] Scope 9 — Commit command (9.1–9.4)
- [x] Scope 10 — Init command (10.1–10.4)
- [x] Scope 11 — Tests (11.1–11.6)
- [x] Scope 12 — Docs + release (12.1–12.3)
